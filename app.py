    ...
    if any(in_data):
        ...
        for j in range(len(OCTAVE_BANDS) - 1):
            ...
            for i in range(NUM_HPS):
                ...
                #socketio.emit('note_detected', {'note': closest_note, 'amplitude': signal_power})
                # TO DO: note, amplitude, FFT waves
                socketio.emit('note_detected', { 'note': closest_note,'amplitude': signal_power,'frequency': max_freq })
